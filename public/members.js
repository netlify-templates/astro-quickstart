...
var leftMembers = {
  ...
  lorelai: {date: '04/25/2023'},
  sam: {date: 'the start of the new year'}, 
  ryan: {date: 'an unknown date'},
  mychelle: {date: 'an unknown date'},
  olivia: {date: 'an unknown date'},
  michael: {date: 'an unknown date'},
  vivi: {date: true},
